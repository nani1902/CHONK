...
@pytest.mark.parametrize(
    ("overrides", "message"),
    [
        ({"target_bytes": 0}, "positive whole number"),
        ({"target_bytes": -5}, "positive whole number"),
        ({"target_bytes": True}, "positive whole number"),
        ({"target_bytes": 1.5}, "positive whole number"),
        ({"min_dpi": 0}, "DPI values must be positive"),
        ({"min_dpi": 700}, "minimum DPI cannot be greater"),
        ({"max_attempts": 1}, "at least 2"),
